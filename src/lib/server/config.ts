...
export const MODELS = {
 ...
 creator: { paraphrase:'qwen/qwen3.6-35b-a3b', text:'meta/muse-spark-1.2-contributor', character:'z-ai/glm-5.3-flash:batch', image:'meta/muse-image', song:'google/lyria-3-clip-preview', video:'alibaba/wan-3.0-prime', videoFallback:'minimax/hailuo-3-max' }
} as const;
